import type { Vmd, VmdMorphFrame, VmdMotionFrame } from '@noname0310/mmd-parser'
...
export class AnimationBuilder {
   ...
   * @param mesh - tracks will be fitting to mesh
   */
  private buildSkeletalAnimation(vmd: Vmd, mesh: SkinnedMesh): AnimationClip {
    const pushInterpolation = (array: number[], interpolation: number[], index: number) => {
    ...
    const motions: Record<string, VmdMotionFrame[]> = {}
