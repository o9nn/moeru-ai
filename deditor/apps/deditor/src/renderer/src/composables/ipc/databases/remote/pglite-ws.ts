...
export function useRemotePGLiteWebSocket() {
  const methods = <TMethod extends keyof PGLiteMethods>(method: TMethod) => defineClientMethod<PGLiteMethods, TMethod>('databaseRemotePGLiteWebSocket', method)
